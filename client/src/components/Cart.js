        ...
        <div>
            ...
            {cartItems.length === 0 ? (
                ...
                <ul>
                    {cartItems.map((item) => (
                        <li key={item.productId._id}>
                            <strong>{item.productId ? item.productId.name : "Unknown Product"}</strong> - $
                            {item.productId ? item.productId.price : "0.00"}
                            <img
                                src={item.productId ? item.productId.imageUrl : "default-image.jpg"}
                                alt={item.productId ? item.productId.name : "Unknown Product"}
                                style={{ width: "100px" }}
                            />
                            <p>Quantity: {item.quantity}</p>
                            <div>
